...
t("pulse detonator", "震荡榴弹", "_t")
t("%s is knocked back!", "%s 被击退。", "logSeen")
t("%s resists the knockback!", "%s抵抗了击退！", "logSeen")
t("darkness pull", "黑暗抓取", "_t")
t("%s is pulled!", "%s被拖动!", "logSeen")
t("%s resists the pull!", "%s抵抗了拖动!", "logSeen")
t("darkness pin", "黑暗定身", "_t")
t("%s resists!", "%s抵抗了效果！", "logSeen")
t("drain negative", "吸收负能量", "_t")
t("null_type", "无属性", "_t")
t("light + dark", "光+暗", "_t")
t("blighted needles", "枯萎之针", "_t")
t("infective darkness", "传染黑暗", "_t")
t("fiery vapour", "火焰蒸汽", "_t")
t("repairing", "修复", "_t")
t("mind drone", "精神无人机", "_t")
t("20% chance of physical repulsion", "20% 几率物理排斥", "_t")
t("temporal ripples", "时空波纹", "_t")
t("curse of amakthel", "阿马克泰尔的诅咒", "_t")
t("psionic searing", "精神焦灼", "_t")
t("resource shock", "资源消耗", "_t")
t("smoke cloud", "烟雾云", "_t")
t("lightning web", "闪电之网", "_t")
t("incendiary grenade", "燃烧榴弹", "_t")
t("chemical grenade", "化学榴弹", "_t")
t("shock grenade", "震荡榴弹", "_t")
t("phosphorous", "磷火", "_t")
t("fire wall", "火墙", "_t")
t("volatile fuel", "易燃燃料", "_t")
t("chemical", "化学", "_t")
t("debilitating acid", "腐蚀酸液", "_t")
t("caustic steam", "腐蚀蒸汽", "_t")
t("galvanic", "放电", "_t")
t("occult", "玄机", "_t")
t("terrene", "寒岩", "_t")
...
t("other technomancy", "科技法术: 其他", "_t")
...
t("This medical injector will now be used first if available when using medical salves.", "这个药物注射器是使用药剂的时候的首选注射器。", "logPlayer")
t("By using a direct psionic link to your body you can use even more therapeutics. %d%% efficiency and %d%% cooldown mod.", "与身体建立直接的灵能链接，让你使用药剂更有效率 , 获得 %d%% 效果和 %d%% 冷却系数修正。", "tformat")
